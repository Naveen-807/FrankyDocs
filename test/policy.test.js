...
describe("policy", () => {
    ...
    it("allows payouts to allowlist", () => {
        const decision = evaluatePolicy({ payoutAllowlist: ["0x0000000000000000000000000000000000000001"] }, { type: "PAYOUT", amountUsdc: 1, to: "0x0000000000000000000000000000000000000001" });
